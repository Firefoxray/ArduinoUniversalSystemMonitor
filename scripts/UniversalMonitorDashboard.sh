...
echo "Launching Universal Monitor Dashboard $APP_VERSION from $JAR_PATH"
...
exec "$JAVA_CONTROL_CENTER_RUNTIME_JDK/bin/java" -Djava.awt.headless=false -jar "$JAR_PATH" --dashboard-only "$@"
