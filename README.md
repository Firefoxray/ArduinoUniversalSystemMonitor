# Arduino Universal System Monitor (v11.4)
...
**Current version:** `v11.4` (shared via `VERSION`).
...
## Remote actions (advanced / optional in v11.4)
...
Actions can run locally or over SSH (saved target profiles supported). This is intended as an advanced helper path, not a required setup path for v11.4.
