# Arduino Universal System Monitor (v11.5 Beta)
...
**Current version:** `v11.5 Beta` (shared via `VERSION`).
...
## Remote actions (advanced / optional in v11.5 Beta)
...
Actions can run locally or over SSH (saved target profiles supported). This is intended as an advanced helper path, not a required setup path for v11.5 Beta.
